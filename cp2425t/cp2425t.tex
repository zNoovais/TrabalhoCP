...
\centerline{
    ...
    &
        \ensuremath{(({\Conid{A}\times\Conid{Int}}^{*})\times\N_0)\times\Conid{Int}}
...
\xymatrix@C=3cm@R=1.5cm{
        \ensuremath{\Conid{Vec}\;(\Conid{Vec}\;\Varid{a})}
            \ar[d]_-{\ensuremath{\Varid{outV}}}
    \\
        \ensuremath{[\mskip1.5mu (\Conid{Vec}\;\Varid{a},\Conid{Int})\mskip1.5mu]}
...
\centerline{
    \xymatrix@C=3cm{
        \ensuremath{\Conid{T}\;\Conid{TA}}
            \ar[dd]_-{\mu }
            \ar[r]^-{\ensuremath{\Varid{outV}}}
    &
        \ensuremath{(\Conid{TA}\times\Conid{Int})}^*
            \ar[r]^-{\ensuremath{\map \;(\Varid{outV}\times\Varid{id})}}
    &
        \ensuremath{(({\Conid{A}\times\Conid{Int}}^{*})\times\Conid{Int})}^*
            \ar[dd]^{\ensuremath{\map \;\Varid{aux}}}
    \\
    \\
        \ensuremath{\Varid{x}\mathbin{>==}\Varid{f}\mathrel{=}\Varid{u}\comp (\mathsf{fmap}\;\Varid{x})}
    &
        \ensuremath{(\Conid{A}\times\Conid{Int})}^*
    &
         \ensuremath{(({\Conid{A}\times\Conid{Int}}^{*})\times\Conid{Int})}^*
...
\centerline{
    \xymatrix@C=4cm{
        \ensuremath{\Conid{A}}
        \ar[d]^-{\ensuremath{\conj{\Varid{id}}{\underline{\mathrm{1}}}}}
    \\
        \ensuremath{(\Conid{A}\times\underline{\mathrm{1}})}
        \ar[d]^-{\ensuremath{\Varid{singl}}}
    \\
        \ensuremath{[\mskip1.5mu (\Conid{A}\times\mathrm{1})\mskip1.5mu]}
    }
}
\]
