...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mysuffixes}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
...
\column{110}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{maximumInt}\mathbin{::}[\mskip1.5mu \Conid{Int}\mskip1.5mu]\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{maximumInt}\mathrel{=}\llparenthesis\, \alt{\underline{\mathrm{0}}}{\uncurry{\Varid{max}}}\,\rrparenthesis{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{area}\mathrel{=}\Varid{maximumInt}\comp \map \;\Varid{auxarea}\comp \uncurry{\Varid{zip}}\comp (\uncurry{\Varid{replicate}}\comp \Varid{swap}\times\Varid{id})\comp \conj{\Varid{id}\times\length }{\p2}{}\<[110]%
\>[110]{}\comp (\Varid{id}\times\map \;\Varid{swap}\comp \Varid{zip}\;[\mskip1.5mu \mathrm{1}\mathinner{\ldotp\ldotp}\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment sadsadsda}{}\<[E]%
\\[\blanklineskip]%
